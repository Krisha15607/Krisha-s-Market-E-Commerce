                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="space-y-6">
                        <Link to="/" className="text-3xl font-bold flex items-center gap-2">
                            <span className="text-white">Krisha's</span>Market
                        </Link>
                        ...
                        <div className="flex space-x-4">
                            <a href="https://github.com/krishapanchotiya" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-neutral-700 transition-all duration-300 group">
                                <Github className="w-5 h-5 text-gray-400 group-hover:text-white" />
                            </a>
                            <a href="https://www.instagram.com/krisha_panchotiya/" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-neutral-700 transition-all duration-300 group">
                                <Instagram className="w-5 h-5 text-gray-400 group-hover:text-white" />
                            </a>
                            <a href="https://www.linkedin.com/in/krisha-panchotiya-602a72332/" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-neutral-700 transition-all duration-300 group">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            ...
                            <li>
                                <Link to="/shop" className="text-gray-400 hover:text-white transition-colors flex items-center gap-2 group">
                                    <ArrowRight className="w-4 h-4 opacity-0 -ml-4 group-hover:opacity-100 group-hover:ml-0 transition-all duration-300" />
                                    Shop Now
                                </Link>
                            </li>

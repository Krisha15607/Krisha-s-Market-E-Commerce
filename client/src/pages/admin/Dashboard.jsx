        ...
        <div className="pb-20 md:pb-0">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-6 md:mb-8">
                <div className="bg-white p-4 md:p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center space-x-3 md:space-x-4">
                    <div className="p-4 bg-neutral-100 text-black border border-neutral-200 rounded-xl">
                            ...
                            <tbody className="divide-y divide-gray-50">
                                {stats.recentProducts && stats.recentProducts.map((product) => (
                                    <tr key={product._id} className="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td className="px-4 py-3">
                                            <span className={`px-2 py-1 rounded-full text-xs font-bold ${product.stock > 0 ? 'bg-black text-white' : 'bg-neutral-100 text-neutral-400 border border-neutral-200 line-through'}`}>
